...
<p>Source (ihmc_common_msgs/SO3StreamingMessage):
<pre>{@code
# This is part of the IHMC Common message package.
# It is a lightweight version of SO3TrajectoryMessage designed for streaming.
...
*/
public class SO3StreamingMessage implements ROS2Message<SO3StreamingMessage>
{
   ...
   */
   ...
   @Override
   public void set(SO3StreamingMessage from)
   {
