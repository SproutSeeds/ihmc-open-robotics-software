...
<p>Source (ihmc_common_msgs/EuclideanStreamingMessage):
<pre>{@code
# This is part of the IHMC Common message package.
# It is a lightweight version of EuclideanTrajectoryMessage designed for streaming.
...
*/
public class EuclideanStreamingMessage implements ROS2Message<EuclideanStreamingMessage>
{
   ...
   */
   ...
   /**
      Define the desired 3D linear velocity, expressed in world frame, to be reached.
   */
   private final geometry_msgs.msg.dds.Vector3 linear_velocity_;
   /**
      Define the desired 3D linear acceleration, expressed in world frame, to be reached.
   */
   ...
   public EuclideanStreamingMessage()
   {
      ...
      linear_velocity_ = new geometry_msgs.msg.dds.Vector3();
   ...
   @Override
   public void set(EuclideanStreamingMessage from)
   {
   ...
   public geometry_msgs.msg.dds.Vector3 getLinearVelocity()
   {
