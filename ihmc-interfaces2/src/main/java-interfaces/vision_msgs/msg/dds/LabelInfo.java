...
public class LabelInfo implements ROS2Message<LabelInfo>
{
   ...
   */
   ...
   /**
      ...
      the "UNLABELED" class.
   */
   private final IDLObjectSequence<vision_msgs.msg.dds.VisionClass> class_map_;
   /**
      The value between 0-1 used as confidence threshold for the inference.
   */
   ...
   public LabelInfo()
   {
      ...
      class_map_ = new IDLObjectSequence<vision_msgs.msg.dds.VisionClass>(vision_msgs.msg.dds.VisionClass.class);
   ...
   public IDLObjectSequence<vision_msgs.msg.dds.VisionClass> getClassMap()
   {
      return class_map_;
   }
