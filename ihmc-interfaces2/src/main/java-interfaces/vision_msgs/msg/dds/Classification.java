...
public class Classification implements ROS2Message<Classification>
{
   ...
   /**
      ...
      user-defined threshold.
   */
   private final IDLObjectSequence<vision_msgs.msg.dds.ObjectHypothesis> results_;

   public Classification()
   {
      header_ = new std_msgs.msg.dds.Header();
      results_ = new IDLObjectSequence<vision_msgs.msg.dds.ObjectHypothesis>(vision_msgs.msg.dds.ObjectHypothesis.class);
   ...
   public IDLObjectSequence<vision_msgs.msg.dds.ObjectHypothesis> getResults()
   {
      return results_;
   }
