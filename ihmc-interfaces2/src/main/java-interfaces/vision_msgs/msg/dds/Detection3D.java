...
public class Detection3D implements ROS2Message<Detection3D>
{
   ...
   /**
      ...
      object ids, the scores for any ids not listed are assumed to be 0.
   */
   private final IDLObjectSequence<vision_msgs.msg.dds.ObjectHypothesisWithPose> results_;
   /**
      3D bounding box surrounding the object.
   */
   private final vision_msgs.msg.dds.BoundingBox3D bbox_;
   /**
      ID used for consistency across multiple detection messages. Detections
      of the same object in different detection messages should have the same id.
      This field may be empty.
   */
   ...
   public Detection3D()
   {
      ...
      results_ = new IDLObjectSequence<vision_msgs.msg.dds.ObjectHypothesisWithPose>(vision_msgs.msg.dds.ObjectHypothesisWithPose.class);
   ...
   public IDLObjectSequence<vision_msgs.msg.dds.ObjectHypothesisWithPose> getResults()
   {
      return results_;
   }
