...
public class FootstepPlanningToolboxOutputStatus implements ROS2Message<FootstepPlanningToolboxOutputStatus>
{
   ...
   */
   ...
   /**
      Footstep plan, may be empty depending on the state of the planner, according to footstep_planning_result
   */
   private final controller_msgs.msg.dds.FootstepDataListMessage footstep_data_list_;
   /**
      Body path plan result. Null if no result is available
   */
   ...
   */
   ...
   /**
      Planned body path. Empty if planner failed
   */
   private final IDLObjectSequence<geometry_msgs.msg.dds.Pose> body_path_;
   /**
      Planned body path before smoothing, used for debugging. Empty if planner failed
   */
   private final IDLObjectSequence<geometry_msgs.msg.dds.Point> body_path_unsmoothed_;
   /**
      Goal pose used by the planner. This will be different from the requested goal pose if it's beyond the horizon length.
   */
   private final geometry_msgs.msg.dds.Pose goal_pose_;
   /**
      Object to record various planner timings, helpful for debugging
   */
   private final toolbox_msgs.msg.dds.FootstepPlanningTimingsMessage planner_timings_;
   /**
      Contains planner stack trace if failure is due to an exception
   */
   ...
   public FootstepPlanningToolboxOutputStatus()
   {
      ...
      body_path_ = new IDLObjectSequence<geometry_msgs.msg.dds.Pose>(geometry_msgs.msg.dds.Pose.class);
      body_path_unsmoothed_ = new IDLObjectSequence<geometry_msgs.msg.dds.Point>(geometry_msgs.msg.dds.Point.class);
      goal_pose_ = new geometry_msgs.msg.dds.Pose();
   ...
   public IDLObjectSequence<geometry_msgs.msg.dds.Pose> getBodyPath()
   {
      return body_path_;
   }

   public IDLObjectSequence<geometry_msgs.msg.dds.Point> getBodyPathUnsmoothed()
   {
      return body_path_unsmoothed_;
   }

   public geometry_msgs.msg.dds.Pose getGoalPose()
   {
      return goal_pose_;
   }
