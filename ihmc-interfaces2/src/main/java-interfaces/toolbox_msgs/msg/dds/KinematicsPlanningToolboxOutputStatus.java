...
public class KinematicsPlanningToolboxOutputStatus implements ROS2Message<KinematicsPlanningToolboxOutputStatus>
{
   ...
   */
   ...
   /**
      List of configurations for each key frames.
   */
   private final IDLObjectSequence<toolbox_msgs.msg.dds.KinematicsToolboxOutputStatus> robot_configurations_;
   /**
      Solution quality.
      The total summation of the all solution quality for each key frames.
   */
   ...
   /**
      Suggested message to send to the IHMC walking controller to request the robot to go through the key frames.
   */
   private final controller_msgs.msg.dds.WholeBodyTrajectoryMessage suggested_controller_message_;

   public KinematicsPlanningToolboxOutputStatus()
   {
      plan_id_ = (int) -1;
      key_frame_times_ = new IDLDoubleSequence();
      robot_configurations_ = new IDLObjectSequence<toolbox_msgs.msg.dds.KinematicsToolboxOutputStatus>(toolbox_msgs.msg.dds.KinematicsToolboxOutputStatus.class);
   ...
   public IDLObjectSequence<toolbox_msgs.msg.dds.KinematicsToolboxOutputStatus> getRobotConfigurations()
   {
