...
<p>Source (controller_msgs/HeadTrajectoryMessage):
<pre>{@code
# This message is part of the IHMC whole-body controller API.
# This message commands the controller to move in taskspace the head to the desired orientation while going through the specified trajectory points.
# A Hermite based curve (third order) is used to interpolate the orientations.
...
*/
public class HeadTrajectoryMessage implements ROS2Message<HeadTrajectoryMessage>
{
   ...
   */
   ...
   /**
      The orientation trajectory information.
   */
   private final ihmc_common_msgs.msg.dds.SO3TrajectoryMessage so3_trajectory_;
   ...
   @Override
   public void set(HeadTrajectoryMessage from)
   {
