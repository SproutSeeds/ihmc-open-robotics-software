...
<p>Source (controller_msgs/NeckDesiredAccelerationsMessage):
<pre>{@code
# This message is part of the IHMC whole-body controller API.
# This message gives the user the option to bypass IHMC feedback controllers for the neck joints by sending desired neck joint accelerations.
# One needs experience in control when activating the bypass as it can result in unexpected behaviors for unreasonable accelerations.
...
*/
public class NeckDesiredAccelerationsMessage implements ROS2Message<NeckDesiredAccelerationsMessage>
{
   ...
   */
   ...
   /**
      The desired joint acceleration information.
   */
   private final controller_msgs.msg.dds.DesiredAccelerationsMessage desired_accelerations_;
   ...
   @Override
   public void set(NeckDesiredAccelerationsMessage from)
   {
