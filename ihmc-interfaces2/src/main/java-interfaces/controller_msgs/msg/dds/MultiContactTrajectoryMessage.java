...
public class MultiContactTrajectoryMessage implements ROS2Message<MultiContactTrajectoryMessage>
{
   ...
   */
   ...
   /**
      Terminal root joint pose in world frame
   */
   private final geometry_msgs.msg.dds.Pose root_joint_pose_;
   /**
      Hash of joint array
   */
   ...
   public MultiContactTrajectoryMessage()
   {
      ...
      root_joint_pose_ = new geometry_msgs.msg.dds.Pose();
   ...
   public geometry_msgs.msg.dds.Pose getRootJointPose()
   {
