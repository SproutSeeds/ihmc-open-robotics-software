...
/**
<p>Source (behavior_msgs/BuildingExplorationDefinitionMessage):
<pre>{@code
# Parent definition fields
behavior_msgs/BehaviorTreeNodeDefinitionMessage definition
}</pre>
*/
public class BuildingExplorationDefinitionMessage implements ROS2Message<BuildingExplorationDefinitionMessage>
{
   ...
   */
   ...
   @Override
   public void set(BuildingExplorationDefinitionMessage from)
   {
