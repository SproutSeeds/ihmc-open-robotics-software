...
/**
<p>Source (behavior_msgs/BuildingExplorationStateMessage):
<pre>{@code
# Parent state fields
behavior_msgs/BehaviorTreeNodeStateMessage state

# Definition
behavior_msgs/BuildingExplorationDefinitionMessage definition

}</pre>
*/
public class BuildingExplorationStateMessage implements ROS2Message<BuildingExplorationStateMessage>
{
   ...
   */
   ...
   /**
      Definition
   */
   private final behavior_msgs.msg.dds.BuildingExplorationDefinitionMessage definition_;
   ...
   @Override
   public void set(BuildingExplorationStateMessage from)
   {
